...
// Fixture lengkap — 10 asset / job_desk / worker, mirror dari
// factory_workflow_digital_twin.json (Sweet Bread, PT XYZ Yogyakarta).
export const digitalTwinMockData: DigitalTwin = {
  factory_info: {
  ...
  assets: [
    {
      ...
      metric_derivation_reasoning:
        "Timbangan digital tidak menghasilkan getaran/kebisingan signifikan. Beban fisik rendah karena operator hanya menakar dan memasukkan bahan sesuai formulasi. Nilai numerik (kapasitas, biaya) diestimasi, tidak tercantum di tabel sumber.",
    },
    {
      asset_id: "ast-02",
      asset_name: "Mixer",
      ...
      metric_derivation_reasoning:
        "Mixer menghasilkan kebisingan & getaran menengah selama proses pengadukan adonan. QC pada tahap ini ketat (homogenitas, elastisitas adonan), sehingga fokus kognitif operator dinilai tinggi di job_desks.",
    },
    {
      asset_id: "ast-03",
      ...
      metric_derivation_reasoning:
        "Mesin pembagi adonan otomatis dengan getaran mekanis sedang. Operator hanya mengoperasikan dan memantau, tanpa QC checklist eksplisit di tabel sumber.",
    },
    {
      asset_id: "ast-04",
      ...
      metric_derivation_reasoning:
        "Mesin pembentuk adonan (rounder/sheeter) otomatis. Tidak ada QC eksplisit di tabel; peran operator terbatas pada pengawasan proses.",
    },
    {
      asset_id: "ast-05",
      ...
      metric_derivation_reasoning:
        "Breadline machine menata adonan ke baking tin. QC ketat pada jarak antar adonan (±4 cm) menuntut ketelitian visual operator meski beban fisik moderat.",
    },
    {
      asset_id: "ast-06",
      ...
      metric_derivation_reasoning:
        "Proofing cabinet adalah ruang terkendali suhu/kelembapan; beban fisik operator rendah, namun QC menuntut presisi suhu 55-60°C selama 50-60 menit dan pemantauan volume roti.",
    },
    {
      asset_id: "ast-07",
      ...
      metric_derivation_reasoning:
        "Oven menghasilkan panas tinggi (bahaya panas, bukan kebisingan) sehingga physical_strain_index dinaikkan. QC kritikal: suhu 170°C selama 8-10 menit, kematangan & warna roti harus presisi agar tidak gosong.",
    },
    {
      asset_id: "ast-08",
      ...
      metric_derivation_reasoning:
        "Tidak ada peralatan (tabel: '—'); area pendinginan bersifat pasif. Beban fisik berasal dari aktivitas memindahkan loyang/produk secara manual.",
    },
    {
      asset_id: "ast-09",
      ...
      metric_derivation_reasoning:
        "Tidak ada peralatan tercantum ('—'); sortir sepenuhnya manual berbasis inspeksi visual. Beban kognitif tinggi karena daftar cacat yang harus dideteksi cukup panjang (gosong, filling bocor, lengket, hancur, kurang matang, dll.).",
    },
    {
      asset_id: "ast-10",
      ...
      metric_derivation_reasoning:
        "Meski disebut 'Packaging Machine', kolom Otomatisasi bertanda '—' pada tabel sumber, artinya mesin dioperasikan/dijalankan manual oleh operator, bukan berjalan otomatis penuh.",
    },
  ],
  job_desks: [
    {
      ...
      metric_derivation_reasoning:
        "Tugas menimbang bahan sesuai formulasi bersifat rutin dan terstandar, fokus kognitif sedang (ketepatan takaran) dengan beban fisik rendah.",
    },
    {
      job_id: "job-02",
      ...
      metric_derivation_reasoning:
        "QC eksplisit di tabel (homogenitas, elastisitas adonan) menuntut fokus kognitif dan judgement lebih tinggi dibanding tahap penimbangan.",
    },
    {
      job_id: "job-03",
      ...
      qc_requirement: "Tidak ada QC eksplisit pada tabel sumber untuk tahap ini.",
      metric_derivation_reasoning:
        "Peran operator terbatas pada mengoperasikan dan memantau mesin pembagi adonan; tidak ada kriteria QC tertulis di tabel.",
    },
    {
      job_id: "job-04",
      ...
      qc_requirement: "Tidak ada QC eksplisit pada tabel sumber untuk tahap ini.",
      metric_derivation_reasoning:
        "Sama seperti dough dividing, operator hanya mengoperasikan dan memantau proses rounder/sheeter.",
    },
    {
      job_id: "job-05",
      ...
      metric_derivation_reasoning:
        "QC presisi jarak (±4 cm) menuntut ketelitian visual yang konsisten selama proses penataan pada baking tin berjalan.",
    },
    {
      job_id: "job-06",
      ...
      qc_requirement:
        "Memastikan suhu 55-60°C selama 50-60 menit serta adonan mengembang dengan baik (volume roti).",
      metric_derivation_reasoning:
        "Kesalahan pengaturan suhu/waktu proofing berdampak langsung pada kualitas volume roti pada tahap berikutnya (baking), sehingga error_severity dinilai tinggi walau beban fisik rendah.",
    },
    {
      job_id: "job-07",
      ...
      qc_requirement:
        "Memastikan suhu 170°C selama 8-10 menit sehingga kematangan roti sesuai dan tidak gosong (warna roti).",
      metric_derivation_reasoning:
        "Tahap paling kritikal: parameter suhu/waktu presisi, risiko panas tinggi (beban fisik), dan kesalahan berakibat langsung pada kegagalan produk (gosong).",
    },
    {
      job_id: "job-08",
      ...
      qc_requirement: "Tidak ada QC eksplisit pada tabel sumber untuk tahap ini.",
      metric_derivation_reasoning:
        "Tugas manual memindahkan produk ke area pendinginan; beban fisik dari mengangkat/memindahkan, fokus kognitif rendah.",
    },
    {
      job_id: "job-09",
      ...
      qc_requirement:
        "Memeriksa produk cacat: gosong, filling bocor, lengket, hancur, kurang matang, tidak mengembang, tanpa topping, ukuran tidak sesuai, dan cacat lainnya.",
      metric_derivation_reasoning:
        "Daftar kriteria cacat yang panjang dan beragam menuntut fokus kognitif sangat tinggi meski beban fisik rendah; ini adalah gerbang QC akhir sebelum packaging.",
    },
    {
      job_id: "job-10",
      ...
      qc_requirement: "Tidak ada QC eksplisit pada tabel sumber untuk tahap ini.",
      metric_derivation_reasoning:
        "Tugas rutin mengemas produk yang sudah lolos sorting; risiko kesalahan relatif rendah karena QC utama sudah dilakukan di tahap sebelumnya.",
    },
  ],
  workers: [
    {
  ...
  llm_compatibility_and_evaluations: [
    {
      ...
      asset_id: "ast-01",
      evaluations: {
        overall_compatibility_score: 0.78,
        throughput_multiplier: 1.05,
        error_multiplier: 0.85,
        fatigue_accumulation_rate: 0.6,
        stress_sensitivity_factor: 0.7,
      },
      llm_reasoning:
        "Dedi (8 thn pengalaman) cukup mumpuni untuk tugas penimbangan yang rutin; beban fisik rendah menjaga akumulasi kelelahan tetap rendah.",
    },
    {
      worker_id: "wrk-02",
      job_id: "job-02",
      ...
      evaluations: {
        ...
        fatigue_accumulation_rate: 0.65,
        stress_sensitivity_factor: 0.6,
      },
      llm_reasoning:
        "Ratna memiliki resiliensi kognitif tinggi (0.82) yang cocok dengan tuntutan QC mixing (homogenitas & elastisitas adonan).",
    },
    {
      worker_id: "wrk-03",
      job_id: "job-03",
      ...
      evaluations: {
        ...
        stress_sensitivity_factor: 0.65,
      },
      llm_reasoning:
        "Agus (12 thn pengalaman) stabil pada tugas pengoperasian mesin pembagi adonan yang repetitif namun cukup melelahkan secara fisik.",
    },
    {
      worker_id: "wrk-04",
      job_id: "job-04",
      ...
      evaluations: {
        ...
        error_multiplier: 0.85,
        fatigue_accumulation_rate: 0.55,
        stress_sensitivity_factor: 0.6,
      },
      llm_reasoning:
        "Sri memiliki stamina fisik tinggi (0.85) yang cocok untuk tugas pengoperasian mesin pembentuk adonan yang terus-menerus.",
    },
    {
      worker_id: "wrk-05",
      job_id: "job-05",
      ...
      evaluations: {
        ...
        throughput_multiplier: 1.05,
        error_multiplier: 0.75,
        fatigue_accumulation_rate: 0.6,
        stress_sensitivity_factor: 0.65,
      },
      llm_reasoning:
        "Yusuf cukup teliti untuk memenuhi QC jarak antar adonan (±4cm) pada breadline yang bergerak cepat.",
    },
    {
      worker_id: "wrk-06",
      job_id: "job-06",
      asset_id: "ast-06",
      evaluations: {
        overall_compatibility_score: 0.86,
        throughput_multiplier: 1.0,
        error_multiplier: 0.6,
        fatigue_accumulation_rate: 0.4,
        stress_sensitivity_factor: 0.55,
      },
      llm_reasoning:
        "Wahyu menjaga presisi suhu/waktu proofing dengan baik; beban fisik rendah menjaga kelelahan tetap rendah meski tanggung jawab QC tinggi.",
    },
    {
      worker_id: "wrk-07",
      job_id: "job-07",
      ...
      llm_reasoning:
        "Bambang (18 thn pengalaman, cognitive_resilience 0.90) sangat presisi pada tahap baking yang kritikal, namun panas oven tinggi (physical_strain_index 0.55) dikombinasikan 5 shift berturut-turut mempercepat akumulasi kelelahan (1.35x) - menjadi worker dengan burnout risk tertinggi saat ini.",
    },
    {
      worker_id: "wrk-08",
      job_id: "job-08",
      ...
      evaluations: {
        ...
        fatigue_accumulation_rate: 0.45,
        stress_sensitivity_factor: 0.5,
      },
      llm_reasoning:
        "Indah masih baru (2 thn pengalaman) namun tugas cooling bersifat sederhana sehingga kompatibilitasnya tetap memadai.",
    },
    {
      worker_id: "wrk-09",
      job_id: "job-09",
      ...
      evaluations: {
        ...
        throughput_multiplier: 1.0,
        error_multiplier: 0.55,
        fatigue_accumulation_rate: 0.5,
        stress_sensitivity_factor: 0.65,
      },
      llm_reasoning:
        "Hendra (10 thn pengalaman, cognitive_resilience 0.85) andal mendeteksi ragam cacat produk pada tahap QC akhir sebelum packaging.",
    },
    {
      worker_id: "wrk-10",
      job_id: "job-10",
      asset_id: "ast-10",
      evaluations: {
        overall_compatibility_score: 0.79,
        throughput_multiplier: 1.02,
        error_multiplier: 0.9,
        fatigue_accumulation_rate: 0.5,
        stress_sensitivity_factor: 0.55,
      },
      llm_reasoning:
        "Lestari cukup kompeten pada tugas pengemasan rutin dengan risiko kesalahan rendah karena QC utama sudah selesai di tahap sortir.",
    },
  ],
};